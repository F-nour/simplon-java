...
public class BanqueDeDonnee {
	...
	public static ArrayList<Restaurant> listeRestaurants = new ArrayList<Restaurant> (Arrays.asList(
		new Restaurant(), new Restaurant("Latte sur les rochers"), new Restaurant("Une tasse de joie")
	)) ;
