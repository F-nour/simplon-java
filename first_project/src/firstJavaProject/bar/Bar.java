...
public class Bar {
	...
	public static void main(String args[])
	{
		...
		int checkEtranges = JOptionPane.showConfirmDialog(null, "Méme les clients étranges aiment bien le café ! "
		...
		+ "\n\nMon Client 2 devrait avoir 2000ml de café et étre facturé 50"
		+ "\nIl a " + mesClientsEtrange.get(1).tasse.cafe.quantiteLiquideMl + "ml de café facturé é " + mesClientsEtrange.get(1).valeurFacture
		+ "\n\nMon Client 3 devrait avoir 1000ml de café et étre facturé 50"
		+ "\nIl a " + mesClientsEtrange.get(2).tasse.cafe.quantiteLiquideMl + "ml de café facturé é " + mesClientsEtrange.get(2).valeurFacture
		+ "\n\nC'est réussi ? ");
