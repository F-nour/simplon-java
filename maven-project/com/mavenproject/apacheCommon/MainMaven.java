package com.mavenproject.apacheCommon;
...
public class MainMaven {
	...
	public static void main(String[] args) {
		...
		System.out.println("Il était le " + DateFormatUtils.format(new Date(), "dd-MM-Y à HH:mm:ss")  + " Quand j'ai appris comment utilisé Maven et apacheUtils");
		
		System.out.println("Je vous pari que la " + Fraction.ONE_HALF + " d'entr	 e vous ne lirons pas aussi loin");
